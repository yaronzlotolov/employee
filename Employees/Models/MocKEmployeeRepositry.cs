    ...
    public class MocEmployeeRepositry : IEmployeeRepositry
    {
        ...
        public MocEmployeeRepositry()
        {
            ...
            _employeelist = new List<Employee>()
            {
                ...
                new Employee() { Id = 1, Name = "oded", Role = Dept.PointGuard, Email = "oded@nba.com"},
                new Employee() { Id = 2, Name = "doron", Role = Dept.PowerForward, Email = "doron@nba.com" },
                new Employee() { Id = 3, Name = "omri", Role = Dept.SmallForward, Email = "omri@nba.com" },
            };
        }
